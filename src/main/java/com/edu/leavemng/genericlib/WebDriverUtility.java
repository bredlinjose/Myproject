...
public class WebDriverUtility 
{
	...
	public void waitForElementInDOM(WebDriver driver) {
		driver.manage().timeouts().implicitlyWait(IConstants.Implicitily_Timeout, TimeUnit.SECONDS);
	}
	...
	public void waitForPage(WebDriver driver , String partailPageURL) {
		WebDriverWait wait = new WebDriverWait(driver, IConstants.Explicitily_Timeout);
	...
	/**
	 * used to scroll the page with x, y coordinate 
	 * @param driver
	 * @param javaScript with x and y
	 */
	public void executeJavaScriptScroll(WebDriver driver , String javaScript) {
